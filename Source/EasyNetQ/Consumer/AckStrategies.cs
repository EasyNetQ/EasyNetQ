...
public static class AckStrategies
{
    ...
    /// </summary>
    public static readonly AckStrategyAsync Ack = async (model, tag, cancellationToken) =>
    {
    ...
    /// </summary>
    public static readonly AckStrategyAsync NackWithoutRequeue = async (model, tag, cancellationToken) =>
    {
    ...
    /// </summary>
    public static readonly AckStrategyAsync NackWithRequeue = async (model, tag, cancellationToken) =>
    {
