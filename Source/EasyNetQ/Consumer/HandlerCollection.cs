...
namespace EasyNetQ.Consumer
{
    public class HandlerCollection : IHandlerCollection
    {
        ...
        public IHandlerRegistration Add<T>(Func<IMessage<T>, MessageReceivedInfo, CancellationToken, Task> handler) where T : class
        {
        ...
        public Func<IMessage<T>, MessageReceivedInfo, CancellationToken, Task> GetHandler<T>() where T : class
        {
