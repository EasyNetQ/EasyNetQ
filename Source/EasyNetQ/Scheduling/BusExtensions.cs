...
namespace EasyNetQ.Scheduling
{
    public static class BusExtensions
    {
        ...
        {
            bus.Scheduler().FuturePublish(futurePublishDate, message);
        }
        ...
        /// <param name="message">The message to response with</param>
        public static void FuturePublish<T>(this IBus bus, DateTime futurePublishDate, T message, string cancellationKey) where T : class
        {
            bus.Scheduler().FuturePublish(futurePublishDate, message, cancellationKey);
        }
        ...
        /// <param name="cancellationKey">An identifier that can be used with CancelFuturePublish to cancel the sending of this message at a later time</param>
        /// <param name="message">The message to response with</param>
        public static Task FuturePublishAsync<T>(this IBus bus, DateTime futurePublishDate, T message, string cancellationKey) where T : class
        {
