...
namespace EasyNetQ.MessageVersioning
{
	...
	{
		private readonly Stack<Type> _messageVersions;

		public MessageVersionStack( Type messageType )
		{
			_messageVersions = ExtractMessageVersions( messageType );
		}

		public Type Pop()
		{
			return _messageVersions.Pop();
		}
		...
		{
			return _messageVersions.GetEnumerator();
		}
