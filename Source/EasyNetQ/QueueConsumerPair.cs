...
namespace EasyNetQ
{
    public class QueueConsumerPair
    {
        ...
        private QueueConsumerPair(IQueue queue, Func<byte[], MessageProperties, MessageReceivedInfo, Task> onMessage, Action<IHandlerRegistration> handlers)
        {
            Queue = queue;
            OnMessage = onMessage;
            Handlers = handlers;
        ...
        public Action<IHandlerRegistration> Handlers { get; }
