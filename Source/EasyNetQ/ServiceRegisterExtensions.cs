...
public static class ServiceRegisterExtensions
{
    ...
    )
    {
        ...
        serviceRegister
            ...
            .TryRegister<IServiceResolver, MicrosoftDIServiceResolver>()
            ...
            .TryRegister<IPersistentChannelFactory>(x => new PersistentChannelFactory(x.Resolve<ILogger<PersistentChannel>>(), x.Resolve<IEventBus>()))
    ...
    {
        return serviceRegister.Register<IConsumeErrorStrategy>(SimpleConsumeErrorStrategy.Ack);
    }
    ...
    {
        return serviceRegister.Register<IConsumeErrorStrategy>(SimpleConsumeErrorStrategy.NackWithRequeue);
    }
    ...
    {
        return serviceRegister.Register<IConsumeErrorStrategy>(SimpleConsumeErrorStrategy.NackWithoutRequeue);
    }
}
