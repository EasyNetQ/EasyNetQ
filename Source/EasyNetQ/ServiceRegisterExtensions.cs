...
public static class ServiceRegisterExtensions
{
    ...
    )
    {
        serviceRegister
            ...
            .TryRegister<IErrorQueueConsumerErrorStrategyConventions, ErrorQueueConsumerErrorStrategyConventions>()
            .TryRegister<IConsumerErrorStrategy, ErrorQueueConsumerErrorStrategy>()
