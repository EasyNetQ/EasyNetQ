...
internal static class PersistentChannelDispatcherExtensions
{
    public static ValueTask<bool> InvokeAsync(
        ...
        dispatcher.InvokeAsync<bool, ActionBasedPersistentChannelAction>(
            new ActionBasedPersistentChannelAction(channelAction), options, timeoutToken, cancellationToken
        );
    ...
    public static ValueTask<TResult> InvokeAsync<TResult>(
        ...
        dispatcher.InvokeAsync<TResult, FuncBasedPersistentChannelAction<TResult>>(
            new FuncBasedPersistentChannelAction<TResult>(channelAction), options, timeoutToken, cancellationToken
        );
}
