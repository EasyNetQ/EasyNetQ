...
#pragma warning restore IDISP004
    ...
    public async Task Should_be_able_to_publish_struct()
    {
        ...
        await pubSub.PublishAsync(message, messageType, publishConfigure, cancellationToken: default);
...
#pragma warning restore IDISP004
        ...
        await using var _ = await pubSub.SubscribeAsync("Id", messageType, (_, _, _) => Task.FromResult(AckStrategies.AckAsync), subscribeConfigure, cancellationToken: default);
