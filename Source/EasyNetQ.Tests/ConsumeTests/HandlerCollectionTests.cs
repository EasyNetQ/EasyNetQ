...
public class HandlerCollectionTests
{
    ...
    public async Task Should_return_matching_handler()
    {
        ...
        await handler(new Message<MyMessage>(new MyMessage()), default, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Should_return_supertype_handler()
    {
        ...
        await handler(new Message<Dog>(new Dog()), default, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Should_return_a_null_logger_if_ThrowOnNoMatchingHandler_is_false()
    {
        ...
        await handler(new Message<MyOtherMessage>(new MyOtherMessage()), default, cancellationToken: TestContext.Current.CancellationToken);
