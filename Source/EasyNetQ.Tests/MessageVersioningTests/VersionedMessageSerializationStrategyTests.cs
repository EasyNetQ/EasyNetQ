...
namespace EasyNetQ.Tests.MessageVersioningTests
{
    ...
    public class VersionedMessageSerializationStrategyTests
    {
        ...
        public void When_using_the_versioned_serialization_strategy_messages_are_correctly_deserialized()
        {
            ...
            AssertMessageDeserializedCorrectly( deserializedMessage, messageContent, typeof( MyMessage ), p => AssertDefaultMessagePropertiesCorrect( p, messageType, correlationId ) );
            Assert.That( deserializedMessage.Message.Properties.UserId, Is.EqualTo( message.Properties.UserId ), "Additional message properties not serialised" );
        }
        ...
        public void When_using_the_versioned_serialization_strategy_versioned_messages_are_correctly_deserialized()
        {
            ...
            AssertMessageDeserializedCorrectly(deserializedMessage, messageContent, typeof(MyMessageV2), p => AssertVersionedMessagePropertiesCorrect( p, messageType, correlationId, supersededMessageType ));
        }
