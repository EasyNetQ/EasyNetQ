...
#pragma warning restore IDISP004
    ...
    {
        await bus.PubSub.PublishAsync(new TestMessage(), cancellationToken: CancellationToken.None);
        await mockBuilder.DisposeAsync();
...
#pragma warning restore IDISP004
        ...
        _ = bus.Rpc.RequestAsync<TestRequestMessage, TestResponseMessage>(new TestRequestMessage(), cancellationToken: CancellationToken.None);
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
    ...
    {
#pragma warning disable IDISP004
        await bus.PubSub.SubscribeAsync<TestMessage>("abc", _ => { }, cancellationToken: CancellationToken.None);
#pragma warning restore IDISP004
        using var are = WaitForConsumerChannelDisposedMessage();
