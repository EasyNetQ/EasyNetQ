...
namespace EasyNetQ.DI
{
    public static class InjectionExtensions
    {
        ...
        public static Autofac.IContainer RegisterAsEasyNetQContainerFactory(this ContainerBuilder builder, Func<IAdvancedBus> busCreator)
        {
            var adapter = new EasyNetQ.DI.AutofacAdapter(builder);
